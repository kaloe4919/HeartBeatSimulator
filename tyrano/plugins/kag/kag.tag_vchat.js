...
tyrano.plugin.kag.tag.vchat_in = {
  ...
  start: function (pm) {
    ...
    var layer = this.kag.stat.current_layer,
      page = this.kag.stat.current_page,
      j_layer = this.kag.layer.getLayer(layer, page);
    j_layer.css("display", "none");
    j_layer.css("left", -1e5);
    (j_area_chat = $("#vchat_base"))
      .find(".current_vchat")
      .addClass("talked_vchat")
      .removeClass("current_vchat");
    var j_vchat = $(
      '        <div style="right: 0px; margin-right: 5px;" class="vchat current_vchat ">            <div class="v_chat_text vchat-text" style="margin-top: 0px; margin-right: 5px; margin-left: 20px; background-color: rgb(255, 255, 255);">                <h3 class="ribbon20 vchat_chara_name"></h3>                <p class="vchat-text-inner" ></p>            </div>        </div>        ',
    );
    j_vchat.hide();
    var j_area_chat;
    j_vchat
    ...
    ++_vchat_log_count > this.kag.stat.vchat.max_log_count &&
