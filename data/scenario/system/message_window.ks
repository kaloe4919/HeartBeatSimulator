;メッセージレイヤの定義
		...
		[position width=1240 height=237 top=13 left=22 ]
		...
		[ptext name="chara_name_area" layer="message0" color=0xFFFFFF size=26 x=42 y=27 bold="bold" edge="" shadow=""]
		...
		[position layer="message1" width=1240 height=237 top=13 left=22 ]
