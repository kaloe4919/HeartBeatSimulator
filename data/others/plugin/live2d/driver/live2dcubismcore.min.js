            ...
            if (memory)
              return (
                new Uint8Array(
                  ...
                  memory,
                  mocBytes.byteLength,
                ).set(new Uint8Array(mocBytes)),
                (mocBytes = _csm.hasMocConsistency(
                  memory,
                  mocBytes.byteLength,
                )),
                _csm.free(memory),
            ...
            (r
              ? ((u = __dirname + "/"),
                ...
                (w = function (a) {
                  return (
                    assert(
                      (a = (a = v(a, !0)).buffer ? a : new Uint8Array(a))
                        .buffer,
                    ),
                    a
                  );
                      ...
                      if (
                        ...
                        for (
                          ...
                          if (
                            ...
                            (xi = k()),
                            (u[Fi >> 2] =
                              xi < x(-3600) ? x(-3600) : x(A(xi, x(3600)))),
                            !((ti = (ti + 12) | 0) >>> 0 < vi >>> 0))
                          )
                            break;
                        }
        ...
        function z(a) {
          if (W(a)) {
            if (((a = a.slice(V.length)), "boolean" == typeof r && r)) {
              ...
              try {
                for (
                  var e = ya(a), f = new Uint8Array(e.length), c = 0;
                  c < e.length;
                  ++c
                )
                  f[c] = e.charCodeAt(c);
